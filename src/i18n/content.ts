  ...
  es: {
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          tags: ["Angular", "Java", "Spring Boot", "Kubernetes"],
          href: null,
        },
        {
          year: "2024 — hoy",
          scope: "Ayesa",
          metric: "seguros",
          title: "Plataforma para Mutua Montañesa",
          body: "Desarrollo para Mutua Montañesa, mutua colaboradora con la Seguridad Social. Angular en el frontend, Java con Spring Boot en el backend y despliegue sobre Kubernetes.",
          tags: ["Angular", "Java", "Spring Boot", "Kubernetes"],
          href: null,
        },
      ],
    ...
    stack: {
      ...
      groups: [
        ...
        { label: "backend", items: ["Spring Boot", "NestJS", "Node.js", "REST", "Socket.IO"] },
        { label: "datos", items: ["MySQL", "MongoDB", "Redis", "Firebase"] },
        { label: "infraestructura", items: ["Docker", "Kubernetes", "GitLab CI", "Jenkins", "AWS", "Debian"] },
        { label: "edge ml", items: ["openWakeWord", "ONNX", "Piper TTS", "pipelines de entrenamiento"] },
      ],
    },
    contact: {
  ...
  en: {
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          scope: "Ayesa",
          metric: "insurance",
          title: "Platform for Mutua Montañesa",
          body: "Development for Mutua Montañesa, a Spanish occupational insurance mutual. Angular on the frontend, Java with Spring Boot on the backend and Kubernetes deployments.",
          tags: ["Angular", "Java", "Spring Boot", "Kubernetes"],
          href: null,
        },
      ],
    ...
    stack: {
      ...
      groups: [
        ...
        { label: "frontend", items: ["Angular", "NGRX", "React", "Next.js", "React Native", "Astro"] },
        { label: "backend", items: ["Spring Boot", "NestJS", "Node.js", "REST", "Socket.IO"] },
        { label: "data", items: ["MySQL", "MongoDB", "Redis", "Firebase"] },
        { label: "infrastructure", items: ["Docker", "Kubernetes", "GitLab CI", "Jenkins", "AWS", "Debian"] },
        { label: "edge ml", items: ["openWakeWord", "ONNX", "Piper TTS", "training pipelines"] },
      ],
    },
    contact: {
